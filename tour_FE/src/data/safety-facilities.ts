...
/**
 * 섬에 실제로 있는 시설. 안전정보 탭은 섬(도) 단위로만 보여준다.
 * 육지 소재 행정구역 거점(중구·옹진군보건소 등)은 넣지 않고, 섬에 실제로 있는
 * 시설(강화군보건소·영종보건지소 포함)만 해당 섬에 붙인다.
 * TODO(팀): 각 섬의 보건지소·병원·약국·파출소 주소·전화를 공식 출처로 채워 주세요.
 */
export const ISLAND_SAFETY: Record<string, SafetyFacility[]> = {
  // 백령·대청도권역
  baek: [
    { type: "health-center", name: "백령보건지소", address: "인천 옹진군 백령면 북포리 522-6", phone: "032-899-3183", verified: true },
    { type: "hospital", name: "백령한의원", address: "인천 옹진군 백령면 백령로 273", phone: "032-836-7582", verified: true },
    { type: "fire-station", name: "백령119안전센터", address: "인천 옹진군 백령면 백령남로 30", phone: "032-836-0119", verified: true },
    { type: "police", name: "백령파출소", address: "인천 옹진군 백령면 백령로278번길 57", phone: "032-760-8316", verified: true },
    { type: "coast-guard", name: "백령파출소", address: "인천 옹진군 백령면 백령로 68-81", phone: "032-650-2239", verified: true },
    { type: "coast-guard", name: "용기포출장소", address: "인천 옹진군 백령면 백령로 12", phone: "032-837-6092", verified: true },
  ],
  daech: [
    { type: "health-center", name: "대청보건지소", address: "인천 옹진군 대청면 대청로 3", phone: "032-899-3184", verified: true },
    { type: "police", name: "대청파출소", address: "인천 옹진군 대청면 대청로7번길 9", phone: "032-760-8315", verified: true },
    { type: "coast-guard", name: "대청파출소", address: "인천 옹진군 대청면 대청로 22-1", phone: "032-650-2229", verified: true },
    { type: "coast-guard", name: "소청출장소", address: "인천 옹진군 대청면 소청동로 88-44", phone: "032-650-2437", verified: true },
  ],
  // 연평도권역
  yeonp: [
    { type: "health-center", name: "연평보건지소", address: "인천 옹진군 연평면 연평중앙로 34-22", phone: "032-899-3182", verified: true },
    { type: "health-center", name: "소연평보건진료소", address: "인천 옹진군 연평면 소연평로19번길 28", phone: "032-831-8985", verified: true },
    { type: "police", name: "연평파출소", address: "인천 옹진군 연평면 연평로137번길 5", phone: "032-760-8314", verified: true },
    { type: "coast-guard", name: "연평파출소", address: "인천 옹진군 연평면 연평로 152", phone: "032-650-2225", verified: true },
    { type: "coast-guard", name: "소연평출장소", address: "인천 옹진군 연평면 소연평로 14", phone: "032-650-2132", verified: true },
  ],
  ...
  gangh: [
    ...
    { type: "hospital", name: "임성식내과의원", address: "인천 강화군 강화읍 강화대로 395, 준프라자빌딩 3층", phone: "032-932-3375", verified: true },
    { type: "hospital", name: "중앙의원", address: "인천 강화군 강화읍 강화대로 412", phone: "032-933-2678", verified: true },
    { type: "hospital", name: "유여성의원", address: "인천 강화군 강화읍 강화대로 410, 302호", phone: "032-933-6080", verified: true },
    { type: "hospital", name: "온수의원", address: "인천 강화군 길상면 온수길36번길 2", phone: "032-937-6835", verified: true },
    { type: "hospital", name: "유안과의원", address: "인천 강화군 강화읍 강화대로 412-1", phone: "032-934-2164", verified: true },
    { type: "hospital", name: "강화연세안과의원", address: "인천 강화군 강화읍 중앙로 23", phone: "032-934-7573", verified: true },
    { type: "hospital", name: "강화튼튼신경외과의원", address: "인천 강화군 강화읍 강화대로 387, 이레빌딩", phone: "032-934-8845", verified: true },
    { type: "hospital", name: "임용철마취통증의학과의원", address: "인천 강화군 강화읍 강화대로 395, 5층 502호", phone: "032-932-2486", verified: true },
    ...
    { type: "pharmacy", name: "강화건강약국", address: "인천 강화군 강화읍 강화대로312번길 12", phone: "032-932-0249", verified: true },
    { type: "pharmacy", name: "큰샘온누리약국", address: "인천 강화군 강화읍 중앙로 9", phone: "032-934-0700", verified: true },
    { type: "pharmacy", name: "모던한방약국", address: "인천 강화군 강화읍 중앙로 18", phone: "032-934-7510", verified: true },
    { type: "pharmacy", name: "새봄약국", address: "인천 강화군 강화읍 동문안길 9-1, 청원빌딩", phone: "032-934-1514", verified: true },
    { type: "pharmacy", name: "평생약국", address: "인천 강화군 강화읍 강화대로 440", phone: "032-933-6511", verified: true },
    { type: "pharmacy", name: "보배약국", address: "인천 강화군 강화읍 중앙로 17-9, 강화풍물시장 C-30호", phone: "032-933-0799", verified: true },
    { type: "pharmacy", name: "하하약국", address: "인천 강화군 강화읍 강화대로 395, 준프라자 1층 103호", phone: "032-932-7090", verified: true },
    { type: "pharmacy", name: "은화약국", address: "인천 강화군 강화읍 강화대로 404", phone: "032-933-7570", verified: true },
    { type: "pharmacy", name: "메디팜조은약국", address: "인천 강화군 강화읍 중앙로 45, 정우빌딩", phone: "032-933-9422", verified: true },
    { type: "pharmacy", name: "이화약국", address: "인천 강화군 강화읍 중앙로 27", phone: "032-934-5534", verified: true },
    // 소방서(본서·119안전센터)
    { type: "fire-station", name: "강화소방서", address: "인천 강화군 불은면 중앙로 505", phone: "032-930-5801", verified: true },
    ...
    // 경찰서(본서·지구대·파출소)
    { type: "police", name: "인천강화경찰서", address: "인천 강화군 강화읍 동문안길 17", phone: "032-930-0353", verified: true },
  ...
  gyo: [
    { type: "health-center", name: "교동보건지소", address: "인천 강화군 교동면 교동동로 485-13", phone: "032-930-3547", verified: true },
    { type: "health-center", name: "난정보건진료소", address: "인천 강화군 교동면 교동서로378번길 56-28", phone: "032-934-7807", verified: true },
    { type: "health-center", name: "삼선보건진료소", address: "인천 강화군 교동면 교동북로 222-1", phone: "032-932-4808", verified: true },
    { type: "health-center", name: "상용보건진료소", address: "인천 강화군 교동면 교동동로 208-3", phone: "032-932-4381", verified: true },
  ...
  seok: [
    { type: "health-center", name: "삼산보건지소", address: "인천 강화군 삼산면 삼산북로 439", phone: "032-932-3020", verified: true },
    { type: "health-center", name: "하리보건진료소", address: "인천 강화군 삼산면 삼산북로 790", phone: "032-932-3653", verified: true },
    { type: "health-center", name: "매음보건진료소", address: "인천 강화군 삼산면 어류정길 36", phone: "032-932-3564", verified: true },
  ...
  // 영종구·서해구권역
  yeongj: [
    { type: "health-center", name: "영종보건지소", address: "인천광역시 영종구 운남서로 100-1", phone: "032-760-6806", source: "icjg.go.kr", verified: true },
    { type: "fire-station", name: "운남119안전센터", address: "인천 중구 영종동 307-2", phone: "032-727-6181", verified: true },
    { type: "fire-station", name: "운서119안전센터", address: "인천 중구 흰바위로27번길 16", phone: "032-727-6182", verified: true },
  ],
  muui: [], // 자료 없음 (수집 필요)
  // 영흥도권역
  yheung: [
    { type: "hospital", name: "하나의료조합영흥우리의원", address: "인천 옹진군 영흥면 영흥로176번길 8, 영흥늘푸른센터", phone: "032-886-9411", verified: true },
    { type: "hospital", name: "하나의료조합영흥치과의원", address: "인천 옹진군 영흥면 영흥로176번길 8, 영흥늘푸른센터", phone: "032-836-9411", verified: true },
    { type: "health-center", name: "선재리보건진료소", address: "인천 옹진군 영흥면 선재로 150-9", phone: "032-889-4769", verified: true },
    { type: "pharmacy", name: "영흥우리약국", address: "인천 옹진군 영흥면 영흥로156번길 12-15", phone: "032-888-3634", verified: true },
    { type: "pharmacy", name: "섬약국", address: "인천 옹진군 영흥면 선재로116번길 6, 1층", phone: "032-888-8808", verified: true },
  ...
  // 자월도권역
  jawol: [], // 자료 없음 (수집 필요)
  seungb: [{ type: "health-center", name: "승봉보건진료소", address: "인천 옹진군 자월면 승봉로 90-2", phone: "032-832-7601", verified: true }],
  ijak: [], // 시설 없음으로 확인됨
  // 덕적도권역
  deokj: [
    { type: "health-center", name: "덕적보건지소", address: "인천 옹진군 덕적면 덕적남로 7-1", phone: "032-899-3185", verified: true },
    { type: "health-center", name: "백아보건진료소", address: "인천 옹진군 덕적면 백아로 88", phone: "032-834-9836", verified: true },
  ...
  soya: [{ type: "health-center", name: "소야보건진료소", address: "인천 옹진군 덕적면 소야로 257-1", phone: "032-831-7874", verified: true }],
  mungap: [
