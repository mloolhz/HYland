 ...
 *   화면에는 이 PNG(595KB)를 WebP(품질 90, 64KB)로 바꾼 `.patched.webp` 를 내보낸다.
 *   PNG 를 다시 만들었으면 WebP 도 다시 변환할 것.
 */
import { getIslandColors } from "@/constants/island";
import { ISLANDS } from "@/lib/island-data";
import traced from "./island-map-traced.json";

export const ISLAND_MAP_IMAGE = "/island-explorer-map.patched.webp";
