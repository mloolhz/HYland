...
/**
 * 섬 상세의 머리글·본문. 데스크톱 패널과 모바일 바텀시트(MobileIslandSheet)가
 * 같은 내용을 쓰고, 감싸는 틀(열고 닫는 방식)만 다르다.
 */
export function IslandDetailContent({
  island,
  onClose,
}: {
  island: IslandInfo;
  ...
  return (
    <>
      ...
      <aside
        ...
        aria-modal="true"
      >
        <IslandDetailContent island={island} onClose={onClose} />
      </aside>
    </>
  );
}
